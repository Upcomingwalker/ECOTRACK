class WeatherApp {
    ...
    async getCurrentLocationWeather() {
        try {
            ...
            await this.fetchWeatherData('New Delhi');
        }
    }
    ...
    updateCurrentWeather(data) {
        ...
        document.getElementById('currentTemp').textContent = `${Math.round(this.isCelsius ? current.temp_c : current.temp_f)}°`;
        ...
        document.getElementById('feelsLike').textContent = `Feels like ${Math.round(this.isCelsius ? current.feelslike_c : current.feelslike_f)}°`;
        ...
        data.forecast.forecastday.forEach(day => {
            ...
            forecastCard.innerHTML = `
                ...
                <div class="temp-range">
                    ${Math.round(this.isCelsius ? day.day.maxtemp_c : day.day.maxtemp_f)}° / ${Math.round(this.isCelsius ? day.day.mintemp_c : day.day.mintemp_f)}°
                </div>
